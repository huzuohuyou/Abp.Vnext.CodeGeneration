...
{
    public static class QuestionnaireInvestigationEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE QuestionnaireInvestigationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
