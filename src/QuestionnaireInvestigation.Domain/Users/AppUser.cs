...
namespace QuestionnaireInvestigation.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update QuestionnaireInvestigationDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update QuestionnaireInvestigationEfCoreEntityExtensionMappings to extend the IdentityUser entity
